...
Coming back to the book, I think remembering the associated stories would be a better way to remember each of the following key points. However, oftentimes we don’t have access to the actual books. So here are the main points from the book that I want to keep in mind.
